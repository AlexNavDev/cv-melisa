...
const BlockStudiesThree = ({ data }: Props) => {
  ...
  return (
    <div className="w-78 h-52.5 mb-10 flex items-center justify-between text-text-orange ">
      ...
      <figure className="w-36 h-52.5 flex items-center">
        <img src={img} alt="" className="h-36" />
      </figure>
      <div className="w-25 h-55 flex flex-col justify-between">
...
export default BlockStudiesThree;
